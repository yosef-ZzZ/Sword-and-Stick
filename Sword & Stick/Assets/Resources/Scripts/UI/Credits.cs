...
public class Credits : MonoBehaviour
{
    ...
    case 2:text1.text = "Chief Asset Manager";
                ...
                break;
    case 3:text1.text = "Music Director";
                text2.text = "Aiden Penner";
                break;
    case 4:text1.text = "Sound Effect Manager";
                text2.text = "Isaac Aserra";
                break;
    case 5:text1.text = "Everything About Giant Slime";
                text2.text = "Darwin Alvarez";
                break;
    case 6:text1.text = "Level Designer";
                text2.text = "Isaac Aserra";
                break;
    case 7:text1.text = "Boss Following AI";
                text2.text = "Aiden Penner";
                break;
    case 8:text1.text = "Character Animator";
                text2.text = "Isaac Aserra";
                break;
    case 9:text1.text = "Most Broken Laptop";
                text2.text = "Darwin Alvarez";
                break;
    case 10:text1.text = "Tallest In The Group";
                text2.text = "Isaac Aserra";
                break;
    case 11:text1.text = "Thanks";
                text2.text = "For Playing!";
                break;
    case 12: SceneManager.LoadScene(0);
                break;
